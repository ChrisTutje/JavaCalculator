...
public class CalculatorTester {
    ...
    public void testAdd() {
        ...
        //assertEquals(10.0, Calculator.add(5.0, 5.0), 0.001);
    }
    ...
    public void testExponent() {
        ...
        //assertEquals(1.0, Calculator.exponent(5.0, 0.0), 0.001);
    }

    @Test
    public void testReciprocal() {
        assertEquals(0.25, Calculator.reciprocal(2.0, 2.0), 0.001);
        //assertEquals(1.0, Calculator.reciprocal(5.0, 0.0), 0.001);
    }

    @Test
    public void testFloorDivide() {
        assertEquals(1.0, Calculator.floorDivide(2.0, 2.0), 0.001);
        //assertEquals(0.0, Calculator.floorDivide(1.0, 3.0), 0.001);
    }

    @Test
    public void testModulo() {
        assertEquals(0.0, Calculator.modulo(2.0, 2.0), 0.001);
        //assertEquals(0.0, Calculator.modulo(6.0, 3.0), 0.001);
    }

    @Test
    public void testNegative() {
        assertEquals(-2.0, Calculator.negative(2.0), 0.001);
        //assertEquals(0.0, Calculator.negative(0.0), 0.001);
    }
}
